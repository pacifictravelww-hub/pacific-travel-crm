  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/3 left-0 w-64 h-64 rounded-full opacity-10"
          style={{ background: 'radial-gradient(circle, #06b6d4, transparent)' }} />
        {/* Grid */}
        <div className="absolute inset-0 opacity-5"
          style={{ backgroundImage: 'linear-gradient(rgba(59,130,246,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(59,130,246,0.3) 1px, transparent 1px)', backgroundSize: '50px 50px' }} />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-1">Pacific Travel</h1>
          <p className="text-blue-300/70 text-sm">Your Gateway to Global Adventures</p>
        </div>
        ...
        <div className="rounded-3xl p-8"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  dir="ltr"
                  className="w-full pr-10 pl-4 py-3 rounded-xl text-sm text-white placeholder:text-slate-600 outline-none transition-all"
                  style={{
          ...
          <p className="text-center text-xs text-slate-500 mt-5">
            אין לך חשבון?{' '}
            <Link href="/register" className="text-blue-400 hover:text-blue-300 transition-colors">הירשם</Link>
          </p>
        </div>
